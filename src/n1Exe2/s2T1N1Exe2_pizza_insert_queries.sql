...
INSERT INTO `pizza`.`locality` (`id`, `locality_name`) VALUES (1, 'Rul'), (2, 'Clas');
...
(1, 'Hio', 'Kal', '3287685', '96456353', 'Delivery', 2);

INSERT INTO `pizza`.`delivery_details` (`id`, `delivery_vendor_id`, `delivery_order_id`, `delivery_local_date_time`) VALUES (1, 1, 1, '2023-01-01 00:00:00'),
(1, 2, 2, '2023-01-01 00:00:00');

INSERT INTO `pizza`.`order` (`id`, `order_product_id`, `order_local_date_time`, `order_type`, `order_quantity`, `order_vendor_id`, `order_client_id`, `order_invoice_number`) 
VALUES (1, 1, '2023-01-01 00:00:00', 'Delivery', 3, 1, 1, '434'),
(1, 2, '2023-01-01 00:00:00', 'Delivery',2, 1, 2, '435');
