...
CREATE INDEX `FK_provider_address_id_idx` ON `optic`.`provider` (`provider_address_id` ASC) VISIBLE;
...
CREATE INDEX `FK_brand_provider_id_idx` ON `optic`.`brand` (`brand_provider_id` ASC) VISIBLE;
...
CREATE INDEX `FK_product_brand_id_idx` ON `optic`.`glasses` (`product_brand_id` ASC) VISIBLE;
...
CREATE INDEX `FK_client_address_id_idx` ON `optic`.`client` (`client_adress_id` ASC) VISIBLE;
...
CREATE INDEX `FK_product_id_idx` ON `optic`.`sale` (`product_id` ASC) VISIBLE;

CREATE INDEX `FK_client_id_idx` ON `optic`.`sale` (`client_id` ASC) VISIBLE;
